...
This application interacts with a PostgreSQL database to save user data and is meant for use as parcel delivery service.
...
- User can signin/signout from the application
